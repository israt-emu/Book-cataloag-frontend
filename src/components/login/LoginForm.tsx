...
const LoginForm = () => {
  ...
  return (
    <div className=" flex flex-col justify-center items-center px-2 mt-5 md:mt-0 w-1/2">
      {/* login form  */}
      ...
      <div className="flex flex-col md:p-6 rounded-md sm:p-10 text-gray-800 w-full">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-gray-700">Sign in to access your account</p>
        </div>
        <form
        ...
        >
          <div className="w-4/6 mx-auto">
            <div className="flex mb-6">
              <input
                type="email"
                className="rounded-none rounded-l-lg block flex-1 min-w-0 w-full text-sm p-2.5 border border-gray-400"
                placeholder="Email"
            ...
            <div className="flex">
              <input
                type="password"
                required
                className="rounded-none rounded-l-lg border text-gray-900  focus:border-main block flex-1 min-w-0 w-full text-sm border-gray-400 p-2.5"
                placeholder="*****"
            ...
            <div>
              <div className="flex justify-between mt-2 ">
                <div className="">
                  {" "}
                  <input className="form-check-input appearance-none h-4 w-4 border border-gray-400 rounded-sm bg-white checked:bg-main checked:border-main focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox" value="" id="flexCheckDefault" />
